package me.vastpeng.mall.core.express;

import com.fasterxml.jackson.databind.ObjectMapper;
import me.vastpeng.mall.core.express.config.ExpressProperties;
import me.vastpeng.mall.core.express.dao.ExpressInfo;
import me.vastpeng.mall.core.util.HttpUtil;
...
public class ExpressService {
    ...
    private String encrypt(String content, String keyValue, String charset) {
        ...
        try {
            byte[] src = MD5(content, charset).getBytes(charset);
