...
class ResponseUtil {
    companion object {
        ...
        fun ok(errmsg: String, data: Any): Any {
            val obj = HashMap<String, Any>()
            obj["errno"] = 0
            obj["errmsg"] = errmsg
            obj["data"] = data
        ...
        fun fail(errno: Int, errmsg: String): Any {
            val obj = HashMap<String, Any>()
            obj["errno"] = errno
            obj["errmsg"] = errmsg
            return obj
        ...
        fun badArgument(): Any = fail(401, "参数不对")


        fun badArgumentValue(): Any = fail(402, "参数值不对")


        fun unlogin(): Any = fail(501, "请登录")


        fun serious(): Any = fail(502, "系统内部错误")


        fun unsupport(): Any = fail(503, "业务不支持")

        fun updatedDateExpired(): Any = fail(504, "更新数据已经失效")

        fun updatedDataFailed(): Any = fail(505, "更新数据失败")

        fun unauthz(): Any = fail(506, "无操作权限")
    }
}